...
PROCESS_MANAGER						= pm2
MANAGED_PROCESS_NAME_INSTANCE_1 = magic-pills--i0
MANAGED_PROCESS_NAME_INSTANCE_2 = magic-pills--i1

REMOTE_NSTANCE_BACKOFF_TIME			= 60

REMOTE_USER								= nodeapps
REMOTE_SITE_URL						= 8.12.18.184
SSH_DESTINATION						= $(REMOTE_USER)@$(REMOTE_SITE_URL)

MONGO_DB_NAME												= magic-pills
